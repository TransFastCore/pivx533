...
#ifndef TrumpCoin_QT_WALLETMODEL_H
#define TrumpCoin_QT_WALLETMODEL_H
...
/** Interface to TrumpCoin wallet from Qt view code. */
...
public:
    ...
    bool getPNCollateralCandidate(COutPoint& outPoint);
...
#endif // TrumpCoin_QT_WALLETMODEL_H
