...
#include "qt/trumpcoin/createproposaldialog.h"
#include "qt/trumpcoin/forms/ui_createproposaldialog.h"

#include "qt/trumpcoin/contactsdropdown.h"
...
CreateProposalDialog::CreateProposalDialog(TrumpCoinGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.trumpcoin/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 TRUMP");
...
void CreateProposalDialog::onAddrListClicked()
{
    ...
    if (!menuContacts) {
        ...
        menuContacts = new ContactsDropdown(
                width,
                height,
                dynamic_cast<TrumpCoinGUI*>(parent()),
                this
        );
