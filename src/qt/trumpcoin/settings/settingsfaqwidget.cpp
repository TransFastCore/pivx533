    ...
    clientModel(_model)
{
    ...
    QString stakeContent = formatFAQContent(
        formatFAQOrderedList(
            ...
            formatFAQListItem(tr("You must have a balance of TrumpCoin with a minimum of 600 confirmations.")) +
    ...
    QString supportContent = formatFAQContent(
        formatFAQParagraph(
            tr("We have support channels in most of our official chat groups, for example %1")
                .arg("<a style='color: #b088ff' href='https://discord.TrumpCoin.org'>" + tr("#support in our Discord") + "</a>.")));
