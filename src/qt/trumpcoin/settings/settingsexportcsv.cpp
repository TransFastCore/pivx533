...
#include "qt/trumpcoin/settings/settingsexportcsv.h"
#include "qt/trumpcoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(TrumpCoinGUI* _window, QWidget *parent) :
