...
#include "qt/trumpcoin/sendcustomfeedialog.h"
#include "qt/trumpcoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(TrumpCoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &TrumpCoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
