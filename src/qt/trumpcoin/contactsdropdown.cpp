...
#include <QPainter>
#include <QSizePolicy>
#include "qt/trumpcoin/addresslabelrow.h"
#include "qt/trumpcoin/contactdropdownrow.h"
...
ContactsDropdown::ContactsDropdown(int minWidth, int minHeight, TrumpCoinGUI* _window, QWidget* _parent) : PWidget(_window, _parent)
{
