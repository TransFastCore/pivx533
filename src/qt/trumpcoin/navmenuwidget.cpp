...
#include "qt/trumpcoin/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(TrumpCoinGUI *mainWindow, QWidget *parent) :
...
void NavMenuWidget::connectActions() {
    ...
    connect(ui->btnMaster, &QPushButton::clicked, this, &NavMenuWidget::onPatriotNodesClicked);
...
void NavMenuWidget::onPatriotNodesClicked(){
    window->goToPatriotNodes();
