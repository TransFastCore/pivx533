...
GovernanceWidget::GovernanceWidget(TrumpCoinGUI* parent) :
        PWidget(parent),
...
void GovernanceWidget::setPNModel(PNModel* _mnModel)
{
    mnModel = _mnModel;
}
