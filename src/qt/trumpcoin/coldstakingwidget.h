...
#include "qt/trumpcoin/txviewholder.h"
#include "qt/trumpcoin/tooltipmenu.h"
#include "qt/trumpcoin/sendmultirow.h"
#include "qt/trumpcoin/coldstakingmodel.h"
...
public:
    explicit ColdStakingWidget(TrumpCoinGUI* parent);
    ~ColdStakingWidget();
