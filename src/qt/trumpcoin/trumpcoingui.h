...
#ifndef TrumpCoin_CORE_NEW_GUI_TrumpCoinGUI_H
#define TrumpCoin_CORE_NEW_GUI_TrumpCoinGUI_H
...
#include "qt/trumpcoin/navmenuwidget.h"
#include "qt/trumpcoin/topbar.h"
#include "qt/trumpcoin/dashboardwidget.h"
#include "qt/trumpcoin/send.h"
#include "qt/trumpcoin/receivewidget.h"
#include "qt/trumpcoin/addresseswidget.h"
#include "qt/trumpcoin/coldstakingwidget.h"
#include "qt/trumpcoin/governancewidget.h"
#include "qt/trumpcoin/patriotnodeswidget.h"
#include "qt/trumpcoin/snackbar.h"
#include "qt/trumpcoin/settings/settingswidget.h"
...
/**
  TrumpCoin GUI main class. This class represents the main window of the TrumpCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class TrumpCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit TrumpCoinGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~TrumpCoinGUI();
...
public Q_SLOTS:
    ...
    */
    ...
    void setPNModel(PNModel* mnModel);
...
private:
    ...
    PatriotNodesWidget *masterNodesWidget = nullptr;
...
#endif //TrumpCoin_CORE_NEW_GUI_TrumpCoinGUI_H
