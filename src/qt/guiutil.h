...
/** Utility functions used by the TrumpCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render TrumpCoin addresses in monospace font
...
// Parse "trumpcoin:" URI into recipient object, return true on successful parsing
