...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("04adc0d0245ad8b33b46c097c94b1952b33c4fec47a0cbb2d74bfd068ecc7217d2f5faff0811b223941cc3a93eec88dde5463565995855d0b41e170f6d7ca7b5cf") << OP_CHECKSIG;
...
static Checkpoints::MapCheckpoints mapCheckpoints = {
    {  0,      uint256S("0000c65dcc82b25425fce3c74a342ca4107e6b60dc31015ad42c1c07281b80f8")},
    {  700,  uint256S("0000035eac6b46ed1e85259a2c3398b04dbf20fb7d3716d7106424ac6a406d17")},
    {  2800,  uint256S("000007e74a89abe971be723aa6f8083ab27223f83816565230ba110700f0e50b")},
    {  110000,  uint256S("445727523ea1e1823652a4a0a4f8464637c12e9dd733abc0247d20cf04783d4f")},
    {  200000,  uint256S("f03abd4b1fedc430997e48cc13bee4085c5c8bf3107bf32a2f5362db8e1ca720")},
    {  300000,  uint256S("f4c8f0c10fa470f5cd9972e1dd1fe5630e4b9b60b91592ae929d8e51bfb77d80")},
    {  400000,  uint256S("447eeea5ce08de457eec79c7df5520c6e1ade906019e2dfbbb06095bb20e18c3")},
    {  700000, uint256S("416021c8f8cd252337280119f2581057ee8c0db4203ea5884e81f4b131187aa3")},
    {  800000, uint256S("4dfe8ab65c01975161e118dadc6a0af7bf5de09544b3f2c490cff96a87c8dbef")},
    {  900000, uint256S("1757dc2b34dba42cba2a0bf6fa061d576f59556d71b605ff5c05b44850d4cf86")},
    {  1000000, uint256S("d7b76bcf8c2ac3ed218d00931d1e3690a0e66e3a13f75653c02440dc9cb93515")},
    {  1100000, uint256S("7c82c53317500e649747791a495c0cb16fd05dedbd47023a342395c3f9b514e7")},
    {  1200000, uint256S("251c2bf85dfd23cca6b4772b1d8e53a69e3326eed0c62c28247bcfbd309cd43b")},
    {  1252764, uint256S("e8318d68c94a7476993673966520ae7ae0b84d65a10a3e23b882f45194723757")}
    };

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1637601645, // * UNIX timestamp of last checkpoint block
    1252764,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1551107115, 0xc103, 0x1e0ffff0, 1, 20 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000c65dcc82b25425fce3c74a342ca4107e6b60dc31015ad42c1c07281b80f8"));
        assert(genesis.hashMerkleRoot == uint256S("0xa193048829b780828ef6c4f0dcb2adb8035843586d2e2dbe73de7e5e5b383663"));

        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.powLimit   = uint256S("0x0002ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        ...
        // validation by-pass
        consensus.nTrumpCoinBadBlockTime = 1471401614;    // Skip nBit validation of Block 259201 per PR #915
        consensus.nTrumpCoinBadBlockBits = 0x1c056dac;    // Skip nBit validation of Block 259201 per PR #915
        ...
        consensus.ZC_TimeStart = 1908214600;        
        consensus.ZC_HeightStart = 9863735;
        ...
        consensus.vUpgrades[Consensus::UPGRADE_POS].nActivationHeight           = 3001;
        consensus.vUpgrades[Consensus::UPGRADE_POS_V2].nActivationHeight        = 9615800;
        consensus.vUpgrades[Consensus::UPGRADE_ZC].nActivationHeight            = 9863787;
        consensus.vUpgrades[Consensus::UPGRADE_ZC_V2].nActivationHeight         = 9153160;
        consensus.vUpgrades[Consensus::UPGRADE_BIP65].nActivationHeight         = 9808634;
        consensus.vUpgrades[Consensus::UPGRADE_ZC_PUBLIC].nActivationHeight     = 9880000;
        consensus.vUpgrades[Consensus::UPGRADE_V3_4].nActivationHeight          = 9967000;
        consensus.vUpgrades[Consensus::UPGRADE_V4_0].nActivationHeight          = 9153200;
        consensus.vUpgrades[Consensus::UPGRADE_V5_0].nActivationHeight          = 9700500;
        consensus.vUpgrades[Consensus::UPGRADE_V5_2].nActivationHeight          = 9927000;
        consensus.vUpgrades[Consensus::UPGRADE_V5_3].nActivationHeight          = 9014000;
        ...
        vSeeds.emplace_back("seed1.trumpcoin.com", true);     
        vSeeds.emplace_back("seed2.trumpcoin.com", true);
        vSeeds.emplace_back("seed3.trumpcoin.com", true);    
        vSeeds.emplace_back("seed4.trumpcoin.com", true);
        vSeeds.emplace_back("seed5.trumpcoin.com", true);
        vSeeds.emplace_back("seed1.trumpcoin.global", true);
        vSeeds.emplace_back("seed2.trumpcoin.global", false);
        vSeeds.emplace_back("seed3.trumpcoin.global", false);

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 66);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 29);
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 127);
        ...
        // Sapling
        bech32HRPs[SAPLING_PAYMENT_ADDRESS]      = "ts";
        bech32HRPs[SAPLING_FULL_VIEWING_KEY]     = "tviews";
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "tlsks";
        bech32HRPs[SAPLING_EXTENDED_SPEND_KEY]   = "t-secret-spending-key-main";
        bech32HRPs[SAPLING_EXTENDED_FVK]         = "txviews";
    }
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.emplace_back("trumpcoin-testnet.seed.fuzzbawls.pw", true);
        vSeeds.emplace_back("trumpcoin-testnet.seed2.fuzzbawls.pw", true);

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet trumpcoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet trumpcoin script addresses start with '8' or '9'
...
public:
    CRegTestParams()
    {
        ...
        consensus.nPNCollateralAmt = 100 * COIN;
        consensus.nProposalEstablishmentTime = 60 * 5;  // at least 5 min old to make it into a budget
