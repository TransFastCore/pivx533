...
#ifndef TrumpCoin_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
#define TrumpCoin_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
...
#endif // TrumpCoin_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
