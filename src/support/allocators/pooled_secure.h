...
#ifndef TrumpCoin_SUPPORT_ALLOCATORS_POOLED_SECURE_H
#define TrumpCoin_SUPPORT_ALLOCATORS_POOLED_SECURE_H
...
#endif // TrumpCoin_SUPPORT_ALLOCATORS_POOLED_SECURE_H
