...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("trumpcoin"), "TrumpCoin");
...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://trumpcoin.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/trumpcoin"));
    BOOST_CHECK(validateURL("https://foo.bar/trumpcoin/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.trumpcoin.com"));
