 ...
 *  A CTxDestination is the internal data type encoded in a TrumpCoin address
 */
...
/**
 * Generate a TrumpCoin scriptPubKey for the given CTxDestination. Returns a P2PKH
