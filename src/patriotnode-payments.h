...
public:
    ...
    void AddWinningPatriotnode(CPatriotnodePaymentWinner& winner);
    ...
    bool ProcessPNWinner(CPatriotnodePaymentWinner& winner, CNode* pfrom, CValidationState& state);
...
private:
    ...
    bool CanVote(const COutPoint& outPatriotnode, int nBlockHeight) const;
    void RecordWinnerVote(const COutPoint& outPatriotnode, int nBlockHeight);
};
