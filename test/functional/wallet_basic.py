...
class WalletTest(TrumpCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 TRUMP from 1 to 0 using sendtoaddress call.
        ...
        # Node 1 has:
        # - 1 coin of 1.00 TRUMP
        # - 7 coins of 250.00 TRUMP
        # - 1 coin of 228.9999xxxx TRUMP
