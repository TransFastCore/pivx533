...
COIN = 100000000 # 1 TRUMP in satoshis
...
# Objects that map to trumpcoind objects, which can be serialized/deserialized
...
class CInv:
    typemap = {
        ...
        5: "MSG_TXLOCK_VOTE",
        6: "MSG_SPORK",
        7: "MSG_PATRIOTNODE_WINNER",
        8: "MSG_PATRIOTNODE_SCANNING_ERROR",
        9: "MSG_BUDGET_VOTE",
        10: "MSG_BUDGET_PROPOSAL",
        11: "MSG_BUDGET_FINALIZED",
        12: "MSG_BUDGET_FINALIZED_VOTE",
        13: "MSG_PATRIOTNODE_QUORUM",
        15: "MSG_PATRIOTNODE_ANNOUNCE",
        16: "MSG_PATRIOTNODE_PING",
        17: "MSG_DSTX"
    }
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in trumpcoind indicates these should be deserialized as blocks
...
class Patriotnode(object):
    ...
    def __repr__(self):
        return "Patriotnode(idx=%d, owner=%s, operator=%s, voting=%s, ip=%s, payee=%s, opkey=%s, protx=%s, collateral=%s)" % (
